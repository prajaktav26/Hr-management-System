		...
		while (statusA) {
			...
			do {
				...
				case 2:
					...
					Employee employee = new Employee(empId, empName, empSalary, empAge, empAddress, empMobile, empEmail,
							roleid, deptid);
				...
				case 3:
					...
					Employee employee1 = new Employee(empId1, empName1, empSalary1, empAge1, empAddress1, empMobile1,
							empEmail1, roleid1, deptid1);
